...
swift test  -c release           # 112 tests (foundation + headers + entropy primitives + serialisation), ~50 ms
...
Tests/JXLSwiftTests/          112 tests across foundation, headers, entropy
```
