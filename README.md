...
swift test  -c release           # 233 tests (foundation + headers + entropy primitives + frame header + TOC + entropy section bodies + streaming rANS + Modular tree + tree walk + properties + GroupHeader + per-pixel decoder + WeightedPredictor + ModularImage / metaApply + cross-validation 13-layers-deep), ~50 ms
