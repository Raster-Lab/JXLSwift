...
swift test  -c release           # 107 tests (foundation + headers + entropy primitives + serialisation), ~50 ms
...
Tests/JXLSwiftTests/          107 tests across foundation, headers, entropy
```
