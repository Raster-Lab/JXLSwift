...
swift test  -c release           # 158 tests (foundation + headers + entropy primitives + serialisation), ~50 ms
...
Tests/JXLSwiftTests/          158 tests across foundation, headers, entropy
```
