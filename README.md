...
swift test  -c release           # 103 tests (foundation + headers + entropy primitives + serialisation), ~50 ms
...
Tests/JXLSwiftTests/          103 tests across foundation, headers, entropy
```
