...
**A current-state knowledge map of the project.** Snapshot as of **v0.13.0-dev** (2026-05-29) — the road-to-lossless-1.0 line (conformance gate, robustness sweep + fuzz, `convert`, perf baseline).
...
| | |
|---|---|
| **Version** | v0.14.0 (medical-grade DICOM-validated + non-DICOM CID22-validated; preset-aligned with J2KSwift; perf hygiene landed) |
