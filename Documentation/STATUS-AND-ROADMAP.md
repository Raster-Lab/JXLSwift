...
**A current-state knowledge map of the project.** Snapshot as of **v0.12.0i13** (2026-05-29).
...
| | |
|---|---|
| **Version** | v0.12.0i13 (Phase J line) |
| **Tests** | 684 passing / 7 skipped / 0 failures (`swift test -c release`, ~70 s) |
