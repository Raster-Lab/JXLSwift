...
| Lossless JPEG-1 → JXL transcoding | ⏳ — needs runtime Huffman codec + scan-header parser + entropy decoder + JXL-side encoder bridge above the segment / DQT / DHT layers. |
