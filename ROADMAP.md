...
**Byte-equality investigation (deep)**: AliasTable construction is verified correct against the cjxl-emitted histo[0] (`testAliasTable_HighlySkewedHistogram`). `getPopulationCountPrecision` formula matches libjxl exactly. Bit-position trace shows:
