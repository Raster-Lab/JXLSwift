...
| **v0.9.0 (next)** — pixel byte-equality + AFV + DCT128/256 | ⏳ — Close out the textured-fixture pixel drift via deeper bisection of the DC / CFL / quant-scale chain. AFV (4 variants — special transform basis for the 3-pixel corner). DCT128/256 (extremely rare; only on very large or solid-content frames at low effort). |
...
| **v0.9.0 — Pixel byte-equality + remaining strategies** | Close textured-fixture pixel drift (DC / CFL / quant-scale chain), AFV (4 variants), DCT128/256 | Byte-equal to djxl on cjxl-d=1...10 fixtures |
