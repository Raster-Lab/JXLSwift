...
| Lossless JPEG-1 → JXL transcoding | ⏳ — needs JPEG entropy decoder (Huffman + 0xFF 0x00 byte-unstuffing + RST handling + DC differential + AC zigzag) on top of the codebook layer, then a JXL-side encoder bridge. |
