...
| Lossless JPEG-1 → JXL transcoding | ⏳ — needs DC-differential + AC zigzag/RLE decoder on top of the bit reader, then the IDCT + YCbCr→RGB layers, then the JXL-side encoder bridge. |
