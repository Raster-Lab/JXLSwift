...
| Lossless JPEG-1 → JXL transcoding | ⏳ — needs DHT (Huffman) payload parser + scan-header parser + entropy decoder + JXL-side encoder bridge above the segment / DQT layers. |
